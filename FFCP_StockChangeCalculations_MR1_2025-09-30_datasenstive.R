...
#
# This script has been updated to redact personally identifiable information of landowners

#      Last edited: BR 09-30-2025, BR 04-29-2024, BR 02-23-2024, BR 07-19-2023, DTS, 6-29-2022, adapted from EPB, 2-2-21
...
#     
#   }
#   # Save ranger code to output folder
#   write.csv(ranger_code, paste0(output.folder,cohort,"_ranger_code.csv"))
#   
  # Read in ranger codes generated above
  ranger_code <- read.csv(paste0("INPUT_safe/",cohort,"_ranger_code.csv"))
...
treelist.treat.t0 <- read_xlsx(paste0("INPUT_safe/FFCP_InventoryData_", tx,"_", cohort,"_TC_redacted.xlsx"), sheet = "Tree_Data_Input")
...
treelist.treat.t1 <- read_xlsx(paste0("INPUT_safe/FFCP_InventoryData_", ty, "_", cohort,"_TC_redacted.xlsx"), sheet = "Tree_Data_Input")
...
plotlist.treat.t0 <- read_xlsx(paste0("INPUT_safe/FFCP_InventoryData_", tx, "_", cohort,"_TC_redacted.xlsx"), sheet = "Plot_Data_Input")
...
plotlist.treat.t1 <- read_xlsx(paste0("INPUT_safe/FFCP_InventoryData_", ty, "_", cohort,"_TC_redacted.xlsx"), sheet = "Plot_Data_Input")
...
REF_SPECIES <- read.csv(paste0("INPUT_safe/REF_SPECIES.csv"), na.strings = c("", "#N/A"))

# Storage Factors
sf = read.csv(paste0("INPUT_safe/StorageFactors.csv"))
sf$Region = as.factor(sf$Region)
sf$Type = as.factor(sf$Type)

# FIPS codes and region codes
fips = read.csv(paste0("INPUT_safe/StateFIPS.csv"))
...
STAND_WEIGHT = read_xlsx(paste0("INPUT_safe/STAND_WEIGHT.xlsx"), sheet = "STAND_WEIGHT")
acres <- read_xlsx(paste0("INPUT_safe/STAND_WEIGHT.xlsx"), sheet = "Acres")
