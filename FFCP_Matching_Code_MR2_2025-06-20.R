...
#     This script has been updated for MR2 and matching of the 2023 and 2024 cohorts
#     Last edited: BDSR 6-20-25
...
#### User Specified Values  ####
  cohort <- "Cohort2022" # Specifies the cohort which will be used for labeling input and output files and selecting the appropriate field data
  RP <- "RP2" # Enter the reporting period
  ...
  output.folder <- paste0(RP, "/OUTPUT_", Sys.Date(), "/")
...
#### Import Data ####
  ...
  treelist <- read_xlsx(paste0(RP,"/INPUT/FFCP_InventoryData_T0_", cohort,"_TC.xlsx"), sheet = "Tree_Data_Input") #tree data
  ...
  plotlist <- read_xlsx(paste0(RP,"/INPUT/FFCP_InventoryData_T0_", cohort,"_TC.xlsx"), sheet = "Plot_Data_Input") #plot data
